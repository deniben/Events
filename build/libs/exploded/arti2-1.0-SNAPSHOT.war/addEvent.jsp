...
<form action="${pageContext.request.contextPath}/addEvent" method="post" id="addEventForm">
    <div class="panel-body">
        ...
        <p><label for="name">Event name: </label> <input required type="text" id="name" name="name"></p>
        <p><label for="description">Description:</label></p> <textarea required rows="18" cols="120" type="text" id="description" name="description"></textarea>
